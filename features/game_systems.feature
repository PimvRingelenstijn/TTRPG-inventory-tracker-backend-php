Feature: Game systems API
    ...
    Scenario: Retrieve an existing game system
        Given a game system exists with name "Dungeons & Dragons 5e" and description "The fifth edition of the world's greatest roleplaying game"
    ...
    Scenario: List all game systems
        Given there are 3 game systems in the system
